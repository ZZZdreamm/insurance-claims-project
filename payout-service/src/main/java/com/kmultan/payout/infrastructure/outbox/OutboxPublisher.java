...
/**
 * Polls the outbox and relays events to Kafka. Copied from claim-service on purpose:
 * the two services share no code; a third copy is the trigger to extract a library.
 *
