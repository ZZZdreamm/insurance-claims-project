...
public class AuthController {
    ...
    public AuthController(
            UserAccountRepository accounts, PasswordEncoder passwordEncoder, JwtTokenService tokenService) {
    ...
    public ResponseEntity<?> login(@Valid @RequestBody LoginRequest request) {
        Optional<UserAccount> account = accounts.findByUsername(
    ...
    public UserInfo me() {
        ...
        String displayName =
                accounts.findById(user.id()).map(UserAccount::getDisplayName).orElse(user.username());
